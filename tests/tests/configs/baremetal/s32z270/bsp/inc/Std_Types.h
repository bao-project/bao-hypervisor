 ...
 */
typedef enum {
    STD_TRANSFORMER_UNSPECIFIED = (uint8)0x00, /**< @brief Transformer of a unspecified transformer
                                                  class.*/
    ...
    STD_TRANSFORMER_CUSTOM = (uint8)0xFF /**< @brief Transformer of a custom class not standardized
                                            by AUTOSAR.*/
...
typedef struct {
    Std_TransformerErrorCode errorCode;    /**< @brief The specific meaning of the values of
...
typedef struct {
    Std_TransformerForwardCode errorCode;  /**< @brief The specific meaning of the values of
                                         Std_TransformerErrorCode is to be seen for the specific
                                         transformer chain  for which the data type represents the
                                         transformer error. */
    Std_TransformerClass transformerClass; /**< @brief The transformerClass */
 ...
 */
typedef Std_ReturnType (*Std_ExtractProtocolHeaderFieldsType)(const uint8* buffer, /**< @brief
                                                                                      Buffer
                                                                                      allocated by
                                                                                      the RTE, where
                                                                                      the
