...
#define FXOSC_CTRL_OSCON(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_OSCON_SHIFT)) & FXOSC_CTRL_OSCON_MASK)

#define FXOSC_CTRL_ALC_D_MASK  (0x4U)
#define FXOSC_CTRL_ALC_D_SHIFT (2U)
#define FXOSC_CTRL_ALC_D_WIDTH (1U)
#define FXOSC_CTRL_ALC_D(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_ALC_D_SHIFT)) & FXOSC_CTRL_ALC_D_MASK)

#define FXOSC_CTRL_GM_SEL_MASK  (0xF0U)
#define FXOSC_CTRL_GM_SEL_SHIFT (4U)
#define FXOSC_CTRL_GM_SEL_WIDTH (4U)
#define FXOSC_CTRL_GM_SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_GM_SEL_SHIFT)) & FXOSC_CTRL_GM_SEL_MASK)

#define FXOSC_CTRL_EOCV_MASK  (0xFF0000U)
#define FXOSC_CTRL_EOCV_SHIFT (16U)
#define FXOSC_CTRL_EOCV_WIDTH (8U)
#define FXOSC_CTRL_EOCV(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_EOCV_SHIFT)) & FXOSC_CTRL_EOCV_MASK)

#define FXOSC_CTRL_COMP_EN_MASK  (0x1000000U)
#define FXOSC_CTRL_COMP_EN_SHIFT (24U)
#define FXOSC_CTRL_COMP_EN_WIDTH (1U)
#define FXOSC_CTRL_COMP_EN(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_COMP_EN_SHIFT)) & FXOSC_CTRL_COMP_EN_MASK)

#define FXOSC_CTRL_OSC_BYP_MASK  (0x80000000U)
#define FXOSC_CTRL_OSC_BYP_SHIFT (31U)
#define FXOSC_CTRL_OSC_BYP_WIDTH (1U)
#define FXOSC_CTRL_OSC_BYP(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_OSC_BYP_SHIFT)) & FXOSC_CTRL_OSC_BYP_MASK)
/*! @} */
...
#define FXOSC_STAT_OSC_STAT(x) \
    (((uint32_t)(((uint32_t)(x)) << FXOSC_STAT_OSC_STAT_SHIFT)) & FXOSC_STAT_OSC_STAT_MASK)
/*! @} */
