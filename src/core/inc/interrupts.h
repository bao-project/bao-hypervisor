...
void interrupts_cpu_sendipi(cpuid_t target_cpu, uint64_t ipi_id);
...
void interrupts_vm_inject(struct vm *vm, uint64_t id);
...
void interrupts_arch_ipi_send(cpuid_t cpu_target, uint64_t ipi_id);
