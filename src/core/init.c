 ...
 *
 * @file init.c
 * @brief This source file implements the hypervisor's initialization sequence.
 */
...
/**
 * @brief Hypervisor initialization after boot code execution (by a CPU).
 *
 ...
 * 4. Interrupt subsystem initialization; and finally
 ...
 *      vmm_init(), cpu_is_master(), console_printk(), cpuid_t.
 * @note This function shall never return. If it does, the CPU enters an infinite loop.
 */
