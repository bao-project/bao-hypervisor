    ...
    vmid_t vm_id)
{
    ...
    mem_throt_config(vm_config->mem_throth.period_us, vm_config->mem_throth.vm_num_tickets, vm_config->mem_throth.ticket_budget, vm_config->mem_throth.cpu_num_tickets);
