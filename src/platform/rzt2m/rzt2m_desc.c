...
struct platform platform = {
    ...
    .regions =  (struct mem_region[]) {
        {
            // System RAM (assumes single-core)
            .base = 0x10000000,
            .size = 0x200000    // 2MB
        },
        {
...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[PLAT_NUM_PINS] =
{
  ...
  { .pin = BSP_IO_PORT_18_PIN_4, .pin_cfg = ( (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW | (uint32_t) IOPORT_PIN_P184_PFC_02_TXD4_SDA4_MOSI4) },
  { .pin = BSP_IO_PORT_18_PIN_5, .pin_cfg = ( (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT | (uint32_t) IOPORT_PIN_P185_PFC_02_RXD4_SCL4_MISO4) },
