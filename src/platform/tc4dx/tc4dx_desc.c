...
const struct plat_device dev_array [] = {
    ...
    {   //GETH0.SFR
        ...
        .apu_num = 11,
        .apu_addr = (unsigned long[]) {0x40, 0x60, 0x80, 0xA0, 0xC0, 0xE0, 0x100, 0x120, 0x140, 0x160, 0x180},
    },
    {   //GETH0.RAM
        .dev_base = 0xF9020000,
        .prot_num = 0,
    ...
    {   //eGTM.SFR
        ...
        .apu_num = 7,
        .apu_addr = (unsigned long[]) {0x24, 0x48, 0x6C, 0x1D4, 0x1F8, 0x21C, 0x240, },
    },
    {   //LETH0
        .dev_base = 0xF9400000,
        .prot_num = 1,
        .prot_addr = (unsigned long[]) {0x24},
        .apu_num = 13,
        .apu_addr = (unsigned long[]) {0x40, 0x60, 0x80, 0xA0, 0xC0, 0xE0, 0x100, 0x120, 0x140, 0x160, 0x180, 0x1A0, 0x1C0},
    },
    {   //PPU.STUDMI
        .dev_base = 0xF9810000,
        .prot_num = 0,
